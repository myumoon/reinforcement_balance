...
void FSurvivorsWhipWeapon::OnLevelChanged(FWeaponLevel NewLevel)
{
	CacheParams();
}

void FSurvivorsWhipWeapon::CacheParams()
{
...
void FSurvivorsWhipWeapon::Tick(float Dt)
{
	if (!Logic) return;
...
void FSurvivorsWhipWeapon::StartBurst()
{
...
void FSurvivorsWhipWeapon::SpawnWhipSwing(float DirSign)
{
	FProjectileState P;
...
void FSurvivorsWhipWeapon::ComputeHits(FSurvivorsHitFrame& HitFrame)
{
	if (!Logic) return;
