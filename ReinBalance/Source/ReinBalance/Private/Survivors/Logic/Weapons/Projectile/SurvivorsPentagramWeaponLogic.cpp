...
void FSurvivorsPentagramWeaponLogic::OnLevelChanged(FWeaponLevel NewLevel)
{
	CacheParams();
}

void FSurvivorsPentagramWeaponLogic::CacheParams()
{
...
void FSurvivorsPentagramWeaponLogic::Tick(float Dt)
{
	if (!Logic) return;
...
void FSurvivorsPentagramWeaponLogic::ComputeHits(FSurvivorsHitFrame& HitFrame)
{
