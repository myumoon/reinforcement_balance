...
void FSurvivorsKnifeWeaponLogic::OnLevelChanged(FWeaponLevel NewLevel)
{
	CacheParams();
}

void FSurvivorsKnifeWeaponLogic::CacheParams()
{
...
void FSurvivorsKnifeWeaponLogic::Tick(float Dt)
{
	if (!Logic) return;
...
void FSurvivorsKnifeWeaponLogic::StartBurst()
{
...
void FSurvivorsKnifeWeaponLogic::SpawnKnifeShot()
{
