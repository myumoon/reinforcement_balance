...
void FSurvivorsGarlicWeapon::OnLevelChanged(FWeaponLevel NewLevel)
{
	CacheParams();
}

void FSurvivorsGarlicWeapon::CacheParams()
{
...
void FSurvivorsGarlicWeapon::Tick(float Dt)
{
	if (!Logic) return;
...
void FSurvivorsGarlicWeapon::ComputeHits(FSurvivorsHitFrame& HitFrame)
{
	if (!Logic) return;
