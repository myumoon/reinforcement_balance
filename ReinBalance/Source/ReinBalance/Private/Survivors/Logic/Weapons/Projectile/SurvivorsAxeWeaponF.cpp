...
void FSurvivorsAxeWeapon::OnLevelChanged(FWeaponLevel NewLevel)
{
	CacheParams();
}

void FSurvivorsAxeWeapon::CacheParams()
{
...
void FSurvivorsAxeWeapon::Tick(float Dt)
{
	if (!Logic) return;
...
void FSurvivorsAxeWeapon::StartBurst()
{
	const FPassiveEffects& PE = GetPassiveEffects();
	CooldownTimer = FCooldownSeconds(CachedCooldown * PE.CooldownMult);
...
void FSurvivorsAxeWeapon::SpawnAxeShot()
{
