...
void FSurvivorsLightningRingWeaponLogic::OnLevelChanged(FWeaponLevel NewLevel)
{
	CacheParams();
}

void FSurvivorsLightningRingWeaponLogic::CacheParams()
{
...
void FSurvivorsLightningRingWeaponLogic::Tick(float Dt)
{
	if (!Logic) return;
...
void FSurvivorsLightningRingWeaponLogic::ComputeHits(FSurvivorsHitFrame& HitFrame)
{
