...
void FSurvivorsMagicWandWeapon::OnLevelChanged(FWeaponLevel NewLevel)
{
	CacheParams();
}

void FSurvivorsMagicWandWeapon::CacheParams()
{
...
void FSurvivorsMagicWandWeapon::Tick(float Dt)
{
	if (!Logic) return;
...
void FSurvivorsMagicWandWeapon::StartBurst()
{
...
void FSurvivorsMagicWandWeapon::SpawnWandShot()
{
