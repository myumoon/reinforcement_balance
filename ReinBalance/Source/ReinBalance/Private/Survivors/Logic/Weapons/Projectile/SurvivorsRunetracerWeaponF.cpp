...
void FSurvivorsRunetracerWeapon::OnLevelChanged(FWeaponLevel NewLevel)
{
	CacheParams();
}

void FSurvivorsRunetracerWeapon::CacheParams()
{
...
void FSurvivorsRunetracerWeapon::Tick(float Dt)
{
	if (!Logic) return;
...
void FSurvivorsRunetracerWeapon::StartBurst()
{
...
void FSurvivorsRunetracerWeapon::SpawnRuneShot()
{
