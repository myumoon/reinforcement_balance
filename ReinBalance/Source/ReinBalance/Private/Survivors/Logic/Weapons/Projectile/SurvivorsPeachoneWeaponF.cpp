...
void FSurvivorsPeachoneWeapon::OnLevelChanged(FWeaponLevel NewLevel)
{
	CacheParams();
}

void FSurvivorsPeachoneWeapon::CacheParams()
{
...
void FSurvivorsPeachoneWeapon::UpdateOrbitPos()
{
	if (!Logic) return;
...
void FSurvivorsPeachoneWeapon::Tick(float Dt)
{
	if (!Logic) return;
...
void FSurvivorsPeachoneWeapon::StartBombing()
{
	const FPassiveEffects& PE = GetPassiveEffects();
...
void FSurvivorsPeachoneWeapon::SpawnBombShot()
{
	if (!Logic) return;
