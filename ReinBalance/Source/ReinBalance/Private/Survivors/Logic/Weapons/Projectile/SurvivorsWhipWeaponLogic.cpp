...
void FSurvivorsWhipWeaponLogic::OnLevelChanged(FWeaponLevel NewLevel)
{
	CacheParams();
}

void FSurvivorsWhipWeaponLogic::CacheParams()
{
...
void FSurvivorsWhipWeaponLogic::Tick(float Dt)
{
	if (!Logic) return;
...
void FSurvivorsWhipWeaponLogic::StartBurst()
{
...
void FSurvivorsWhipWeaponLogic::SpawnWhipSwing(float DirSign)
{
	FProjectileState P;
...
void FSurvivorsWhipWeaponLogic::ComputeHits(FSurvivorsHitFrame& HitFrame)
{
	if (!Logic) return;
