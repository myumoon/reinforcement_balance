...
void FSurvivorsMagicWandWeaponLogic::OnLevelChanged(FWeaponLevel NewLevel)
{
	CacheParams();
}

void FSurvivorsMagicWandWeaponLogic::CacheParams()
{
...
void FSurvivorsMagicWandWeaponLogic::Tick(float Dt)
{
	if (!Logic) return;
...
void FSurvivorsMagicWandWeaponLogic::StartBurst()
{
...
void FSurvivorsMagicWandWeaponLogic::SpawnWandShot()
{
