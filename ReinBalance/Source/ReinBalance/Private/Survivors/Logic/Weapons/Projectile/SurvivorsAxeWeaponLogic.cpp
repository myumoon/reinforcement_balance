...
void FSurvivorsAxeWeaponLogic::OnLevelChanged(FWeaponLevel NewLevel)
{
	CacheParams();
}

void FSurvivorsAxeWeaponLogic::CacheParams()
{
...
void FSurvivorsAxeWeaponLogic::Tick(float Dt)
{
	if (!Logic) return;
...
void FSurvivorsAxeWeaponLogic::StartBurst()
{
	const FPassiveEffects& PE = GetPassiveEffects();
	CooldownTimer = FCooldownSeconds(CachedCooldown * PE.CooldownMult);
...
void FSurvivorsAxeWeaponLogic::SpawnAxeShot()
{
