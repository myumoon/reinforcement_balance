...
void FSurvivorsPeachoneWeaponLogic::OnLevelChanged(FWeaponLevel NewLevel)
{
	CacheParams();
}

void FSurvivorsPeachoneWeaponLogic::CacheParams()
{
...
void FSurvivorsPeachoneWeaponLogic::UpdateOrbitPos()
{
	if (!Logic) return;
...
void FSurvivorsPeachoneWeaponLogic::Tick(float Dt)
{
	if (!Logic) return;
...
void FSurvivorsPeachoneWeaponLogic::StartBombing()
{
	const FPassiveEffects& PE = GetPassiveEffects();
...
void FSurvivorsPeachoneWeaponLogic::SpawnBombShot()
{
	if (!Logic) return;
