...
void FSurvivorsKingBibleWeapon::OnLevelChanged(FWeaponLevel NewLevel)
{
	CacheParams();
}

void FSurvivorsKingBibleWeapon::CacheParams()
{
...
void FSurvivorsKingBibleWeapon::ActivateOrbs(const FPassiveEffects& PE)
{
	bOrbsActive = true;
...
void FSurvivorsKingBibleWeapon::RebuildOrbPositions()
{
	if (!Logic) return;
...
void FSurvivorsKingBibleWeapon::Tick(float Dt)
{
	if (!Logic) return;
...
void FSurvivorsKingBibleWeapon::ComputeHits(FSurvivorsHitFrame& HitFrame)
{
