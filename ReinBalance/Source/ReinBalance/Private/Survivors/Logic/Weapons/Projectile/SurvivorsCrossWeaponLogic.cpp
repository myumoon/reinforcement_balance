...
void FSurvivorsCrossWeaponLogic::OnLevelChanged(FWeaponLevel NewLevel)
{
	CacheParams();
}

void FSurvivorsCrossWeaponLogic::CacheParams()
{
...
void FSurvivorsCrossWeaponLogic::Tick(float Dt)
{
	if (!Logic) return;
...
void FSurvivorsCrossWeaponLogic::StartBurst()
{
...
void FSurvivorsCrossWeaponLogic::SpawnCrossShot()
{
