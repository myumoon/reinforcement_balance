...
void FSurvivorsSantaWaterWeapon::OnLevelChanged(FWeaponLevel NewLevel)
{
	CacheParams();
}

void FSurvivorsSantaWaterWeapon::CacheParams()
{
...
void FSurvivorsSantaWaterWeapon::Tick(float Dt)
{
	if (!Logic) return;
...
void FSurvivorsSantaWaterWeapon::StartDropSequence()
{
...
void FSurvivorsSantaWaterWeapon::SpawnDrop(FVector2D DropPos)
{
	FGroundZoneState Z;
	Z.Pos           = DropPos;
