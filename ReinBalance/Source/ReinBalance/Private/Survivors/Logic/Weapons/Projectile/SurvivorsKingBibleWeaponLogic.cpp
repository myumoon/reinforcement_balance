...
void FSurvivorsKingBibleWeaponLogic::OnLevelChanged(FWeaponLevel NewLevel)
{
	CacheParams();
}

void FSurvivorsKingBibleWeaponLogic::CacheParams()
{
...
void FSurvivorsKingBibleWeaponLogic::ActivateOrbs(const FPassiveEffects& PE)
{
	bOrbsActive = true;
...
void FSurvivorsKingBibleWeaponLogic::RebuildOrbPositions()
{
	if (!Logic) return;
...
void FSurvivorsKingBibleWeaponLogic::Tick(float Dt)
{
	if (!Logic) return;
...
void FSurvivorsKingBibleWeaponLogic::ComputeHits(FSurvivorsHitFrame& HitFrame)
{
