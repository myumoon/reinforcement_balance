...
void FSurvivorsGarlicWeaponLogic::OnLevelChanged(FWeaponLevel NewLevel)
{
	CacheParams();
}

void FSurvivorsGarlicWeaponLogic::CacheParams()
{
...
void FSurvivorsGarlicWeaponLogic::Tick(float Dt)
{
	if (!Logic) return;
...
void FSurvivorsGarlicWeaponLogic::ComputeHits(FSurvivorsHitFrame& HitFrame)
{
	if (!Logic) return;
