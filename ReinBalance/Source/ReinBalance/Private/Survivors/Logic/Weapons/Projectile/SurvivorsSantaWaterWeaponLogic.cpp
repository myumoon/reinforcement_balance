...
void FSurvivorsSantaWaterWeaponLogic::OnLevelChanged(FWeaponLevel NewLevel)
{
	CacheParams();
}

void FSurvivorsSantaWaterWeaponLogic::CacheParams()
{
...
void FSurvivorsSantaWaterWeaponLogic::Tick(float Dt)
{
	if (!Logic) return;
...
void FSurvivorsSantaWaterWeaponLogic::StartDropSequence()
{
...
void FSurvivorsSantaWaterWeaponLogic::SpawnDrop(FVector2D DropPos)
{
	FGroundZoneState Z;
	Z.Pos           = DropPos;
