...
void FSurvivorsFireWandWeapon::OnLevelChanged(FWeaponLevel NewLevel)
{
	CacheParams();
}

void FSurvivorsFireWandWeapon::CacheParams()
{
...
void FSurvivorsFireWandWeapon::Tick(float Dt)
{
	if (!Logic) return;
...
void FSurvivorsFireWandWeapon::ComputeHits(FSurvivorsHitFrame& HitFrame)
{
	if (!Logic) return;
