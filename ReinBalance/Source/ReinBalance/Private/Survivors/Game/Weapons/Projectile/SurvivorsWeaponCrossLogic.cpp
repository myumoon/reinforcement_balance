...
void FSurvivorsWeaponCrossLogic::OnLevelChanged(FWeaponLevel NewLevel)
{
	CacheParams();
}

void FSurvivorsWeaponCrossLogic::CacheParams()
{
...
void FSurvivorsWeaponCrossLogic::Tick(float Dt)
{
	if (!Logic) return;
...
void FSurvivorsWeaponCrossLogic::StartBurst()
{
...
void FSurvivorsWeaponCrossLogic::SpawnCrossShot()
{
