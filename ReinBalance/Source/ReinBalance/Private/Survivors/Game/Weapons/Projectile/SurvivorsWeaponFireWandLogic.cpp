...
void FSurvivorsWeaponFireWandLogic::CacheParams()
{
...
void FSurvivorsWeaponFireWandLogic::Tick(float Dt)
{
	if (!Logic) return;
...
void FSurvivorsWeaponFireWandLogic::ComputeHits(FSurvivorsHitFrame& HitFrame)
{
	if (!Logic) return;
