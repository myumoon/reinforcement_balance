...
void FSurvivorsWeaponLightningRingLogic::OnLevelChanged(FWeaponLevel NewLevel)
{
	CacheParams();
}

void FSurvivorsWeaponLightningRingLogic::CacheParams()
{
...
void FSurvivorsWeaponLightningRingLogic::Tick(float Dt)
{
	if (!Logic) return;
...
void FSurvivorsWeaponLightningRingLogic::ComputeHits(FSurvivorsHitFrame& HitFrame)
{
