...
void USurvivorsPentagramWeapon::OnLevelChanged(FWeaponLevel NewLevel)
{
	CacheParams();
}

void USurvivorsPentagramWeapon::CacheParams()
{
...
void USurvivorsPentagramWeapon::Tick(float Dt)
{
	if (!Game) return;
...
void USurvivorsPentagramWeapon::ComputeHits(USurvivorsCollisionComponent* CollComp, FSurvivorsHitFrame& HitFrame)
{
