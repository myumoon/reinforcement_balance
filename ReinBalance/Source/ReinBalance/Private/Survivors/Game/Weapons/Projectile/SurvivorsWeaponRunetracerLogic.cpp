...
void FSurvivorsWeaponRunetracerLogic::OnLevelChanged(FWeaponLevel NewLevel)
{
	CacheParams();
}

void FSurvivorsWeaponRunetracerLogic::CacheParams()
{
...
void FSurvivorsWeaponRunetracerLogic::Tick(float Dt)
{
	if (!Logic) return;
...
void FSurvivorsWeaponRunetracerLogic::StartBurst()
{
...
void FSurvivorsWeaponRunetracerLogic::SpawnRuneShot()
{
