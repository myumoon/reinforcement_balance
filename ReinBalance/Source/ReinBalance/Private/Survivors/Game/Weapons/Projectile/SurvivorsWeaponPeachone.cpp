...
void USurvivorsWeaponPeachone::OnLevelChanged(FWeaponLevel NewLevel)
{
	CacheParams();
}

void USurvivorsWeaponPeachone::CacheParams()
{
...
void USurvivorsWeaponPeachone::UpdateOrbitPos()
{
	if (!Game) return;
...
void USurvivorsWeaponPeachone::Tick(float Dt)
{
	if (!Game) return;
...
void USurvivorsWeaponPeachone::StartBombing()
{
	const FPassiveEffects& PE = GetPassiveEffects();
...
void USurvivorsWeaponPeachone::SpawnBombShot()
{
