...
void USurvivorsWeaponKnife::OnLevelChanged(FWeaponLevel NewLevel)
{
	CacheParams();
}

void USurvivorsWeaponKnife::CacheParams()
{
...
void USurvivorsWeaponKnife::Tick(float Dt)
{
...
void USurvivorsWeaponKnife::StartBurst()
{
...
void USurvivorsWeaponKnife::SpawnKnifeShot()
{
