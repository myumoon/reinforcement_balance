#include "Survivors/Game/SurvivorsSpawnComponent.h"
...
void USurvivorsSpawnComponent::InitDefaultEnemyTable()
{
	...
	static const FRow Rows[] = {
		{ TEXT("Bat"),        1.f,    35.f,  2.f, 2.f, 10.f, 0.f, false },
		{ TEXT("Zombie"),     4.f,    20.f,  3.f, 2.f, 12.f, 0.f, false },
		{ TEXT("Skeleton"),   6.f,  22.5f,  4.f, 2.f, 12.f, 0.f, false },
		{ TEXT("Ghost"),      3.f,    44.f,  3.f, 2.f, 10.f, 0.f, false },
		{ TEXT("Werewolf"),  10.f,    40.f,  5.f, 9.f, 14.f, 0.f, false },
		{ TEXT("Mummy"),     15.f,    18.f,  6.f, 9.f, 14.f, 0.f, false },
		{ TEXT("Plant"),     20.f,    16.f,  7.f, 9.f, 14.f, 0.f, false },
