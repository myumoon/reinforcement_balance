...
def test_contract_dataclasses_are_exact_and_frozen() -> None:
    ...
    expected = {
        ...
        PerceptionSnapshot: ("snapshot_id", "frame_id", "captured_ns", "parser_artifact_hash", "source_content_hash", "ui_state_key", "screen_state", "deploy_obs", "item_context", "choices", "ui_presentation", "diagnostics", "detector_artifact_hash", "ui_policy_input"),
    }
